...
public class MenuHama extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Hama dan Penyakit");
        ...
        try {
            cursor = db.rawQuery("SELECT * FROM NavPestDiase ORDER BY nama ASC", null);
...
//                    tv_nama.setTypeface(sanvitoSB);
    ...
    public void detail(int position) {
        ...
        Intent iIntent = new Intent(this, DB_ParseHama.class);
